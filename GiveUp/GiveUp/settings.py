"""
Django settings for GiveUp project.
...
SECRET_KEY = 'django-insecure-=f!&(ot8yh*kpe9m75p!1cb2&g=(ci#7uxt*)@537-l%0#al*7'
...
WSGI_APPLICATION = 'GiveUp.wsgi.application'
